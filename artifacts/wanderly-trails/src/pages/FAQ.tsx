      ...
      <section className="py-16 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 bg-primary text-white rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="mailto:wanderlytrails.in@gmail.com" className="bg-white/20 hover:bg-white/30 text-white font-semibold px-6 py-2.5 rounded-xl transition-colors text-sm select-none">Email Us</a>
            <a href="https://wa.me/917521824197" target="_blank" rel="noreferrer" className="bg-accent hover:bg-accent/90 text-white font-semibold px-6 py-2.5 rounded-xl transition-colors text-sm select-none">WhatsApp Us</a>
          </div>
        </div>
      </section>
    </div>
